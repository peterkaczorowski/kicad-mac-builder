...
if DYLD_PRINT_LIBRARIES=1 DYLD_PRINT_LIBRARIES_POST_LAUNCH=1 "$1" -c 'print("Hello world.")' 2>&1 | grep /System/Library/Frameworks/Python.framework ; then
...
if ! "$1" -c 'print("Hello" + " " + "World")' 2>&1 | grep 'Hello World' > /dev/null; then
